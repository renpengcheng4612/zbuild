...
public class SignTestShell extends IncrementalTask {
  ...
  static {
    Object object = $getCallSiteArray()[86].call(HMLogger.class, SignTestShell.class);
  ...
  @Inject
  public SignTestShell(VariantData variantData) {
  ...
  public void initModuleSignFiles(File signedApkFile, Map pathMap, PathInfo pathInfo) {
    CallSite[] arrayOfCallSite = $getCallSiteArray();
    if (DefaultTypeTransformation.booleanUnbox(arrayOfCallSite[27].call(this.variantData))) {
      List entryModules = (List)ScriptBytecodeAdapter.castToType(arrayOfCallSite[28].call(ModuleExtensionData.class, arrayOfCallSite[29].callGroovyObjectGetProperty(this)), List.class);
      if (DefaultTypeTransformation.booleanUnbox(arrayOfCallSite[30].call(entryModules)))
        arrayOfCallSite[31].call(hmLogger, arrayOfCallSite[32].callConstructor(GradleException.class, arrayOfCallSite[33].call(String.class, arrayOfCallSite[34].callGetProperty(Locale.class), "An error happened in Task: %s. Unable to pack the APK using the program package shell.", arrayOfCallSite[35].callCurrent((GroovyObject)this))), "package", arrayOfCallSite[36].call(arrayOfCallSite[37].call("the module : ", arrayOfCallSite[38].call(arrayOfCallSite[39].callGroovyObjectGetProperty(this))), " has no any entryModules, please check its build.gradle entryModules")); 
      String entryModule;
      Iterator iterator;
      for (entryModule = null, iterator = (Iterator)ScriptBytecodeAdapter.castToType(arrayOfCallSite[40].call(entryModules), Iterator.class); iterator.hasNext(); ) {
        entryModule = ShortTypeHandling.castToString(iterator.next());
        Object entryApkName = arrayOfCallSite[41].call(arrayOfCallSite[42].call(arrayOfCallSite[43].call(entryModule, "_"), arrayOfCallSite[44].call(this.variantData)), "_signed_cut_entry.apk");
        File signedEntryApk = (File)ScriptBytecodeAdapter.castToType(arrayOfCallSite[45].call(arrayOfCallSite[46].callGroovyObjectGetProperty(this), arrayOfCallSite[47].call(Paths.class, arrayOfCallSite[48].call(pathInfo), entryModule, entryApkName)), File.class);
        String featureEntry = ShortTypeHandling.castToString(arrayOfCallSite[49].call(String.class, arrayOfCallSite[50].callGetProperty(Locale.class), "%s,%s", signedApkFile, signedEntryApk));
        arrayOfCallSite[51].call(pathMap, arrayOfCallSite[52].call(entryModule, "_test"), featureEntry);
      } 
    } else {
      Object entryApkName = arrayOfCallSite[53].call(arrayOfCallSite[54].call(arrayOfCallSite[55].call(arrayOfCallSite[56].callGetProperty(arrayOfCallSite[57].callGroovyObjectGetProperty(this)), "_"), arrayOfCallSite[58].call(this.variantData)), "_unsigned_cut_entry.apk");
      File entryApkPath = (File)ScriptBytecodeAdapter.castToType(arrayOfCallSite[59].call(arrayOfCallSite[60].callGroovyObjectGetProperty(this), arrayOfCallSite[61].call(Paths.class, arrayOfCallSite[62].call(pathInfo), arrayOfCallSite[63].callGetProperty(arrayOfCallSite[64].callGroovyObjectGetProperty(this.variantData)), "cut", entryApkName)), File.class);
      File myEntryApkPath = (File)ScriptBytecodeAdapter.castToType(arrayOfCallSite[65].call(arrayOfCallSite[66].callGroovyObjectGetProperty(this), arrayOfCallSite[67].call(Paths.class, arrayOfCallSite[68].call(pathInfo), arrayOfCallSite[69].callGetProperty(arrayOfCallSite[70].callGroovyObjectGetProperty(this)), entryApkName)), File.class);
      File signFile = (File)ScriptBytecodeAdapter.castToType(arrayOfCallSite[71].call(arrayOfCallSite[72].callGroovyObjectGetProperty(this), arrayOfCallSite[73].call(SignUtil.class, myEntryApkPath)), File.class);
      arrayOfCallSite[74].call(this.signMap, entryApkPath, signFile);
      String featureEntry = ShortTypeHandling.castToString(arrayOfCallSite[75].call(String.class, arrayOfCallSite[76].callGetProperty(Locale.class), "%s", signedApkFile));
      arrayOfCallSite[77].call(pathMap, arrayOfCallSite[78].call(arrayOfCallSite[79].callGetProperty(arrayOfCallSite[80].callGroovyObjectGetProperty(this)), "_test"), featureEntry);
    } 
  }
  
  public void doTaskAction(InputChanges inputChanges) {
    CallSite[] arrayOfCallSite = $getCallSiteArray();
    if (DefaultTypeTransformation.booleanUnbox(arrayOfCallSite[81].call(this.configInfo)))
      return; 
    Reference signUtil = new Reference(ScriptBytecodeAdapter.castToType(arrayOfCallSite[82].callConstructor(SignUtil.class, arrayOfCallSite[83].callGroovyObjectGetProperty(this), MODULE_TYPE, this.variantData), SignUtil.class));
    arrayOfCallSite[84].call(arrayOfCallSite[85].call(inputChanges, this.unsignedApkFiles), new _doTaskAction_closure1(this, this, signUtil));
  }
